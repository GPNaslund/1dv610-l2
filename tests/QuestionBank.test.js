...
describe("QuestionBank class", () => {
  ...
  describe("addQuestion()", () => {
    it("should add a new Question object to allQuestions", () => {
      const questionBank = new QuestionBank();
      const question = new Question({ text: "Is water wet?", choices: ["Yes", "No"], correctChoiceIndex: 0 });
  ...
  describe("createAndAddQuestion()", () => {
    it("should add a new question", () => {
      const questionBank = new QuestionBank();
      questionBank.createAndAddQuestion({ text: "Is water wet?", choices: ["Yes", "No"], correctChoiceIndex: 0 });
  ...
  describe("removeQuestion()", () => {
    it("removes a question with correct arguments", () => {
      const questionBank = new QuestionBank();
      const question = new Question({ text: "Does a dog bark?", choices: ["Yes", "No"], correctChoiceIndex: 0 });
      const question2 = new Question({ text: "Does a fish swim?", choices: ["Yes", "No"], correctChoiceIndex: 0 });
      questionBank.addQuestion(question);
  ...
  describe("getQuestion()", () => {
    it("returns a question at the correct index", () => {
      const questionBank = new QuestionBank();
      const question = new Question({ text: "Is coding the best?", choices: ["Yes", "No"], correctChoiceIndex: 0 });
      questionBank.addQuestion(question);
  ...
  describe("getAllQuestions()", () => {
    it("should work with Question objects stored", () => {
      const questionBank = new QuestionBank();
      const question = new Question({ text: "Does cat say meow?", choices: ["Yes", "No"], correctChoiceIndex: 0 });
      const question2 = new Question({ text: "Do birds fly?", choices: ["Yes", "No", "Maybe"], correctChoiceIndex: 0 });
      questionBank.addQuestion(question);
      questionBank.addQuestion(question2);
  ...
  describe("hasQuestions()", () => {
    it("should return true when questions exist", () => {
      const questionBank = new QuestionBank();
      const question = new Question({ text: "Is testing fun?", choices: ["Yes", "No"], correctChoiceIndex: 0 });
      questionBank.addQuestion(question);
